/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32v30x_fsmc.c Author :
 *WCH Version            : V1.0.0 Date               : 2021/06/06 Description :
 *This file provides all the FSMC firmware functions. Copyright (c) 2021 Nanjing
 ...
 * disabled. FSMC_IT_RisingEdge - Rising edge detection interrupt. FSMC_IT_Level
 * - Level edge detection interrupt. FSMC_IT_FallingEdge - Falling edge
 * detection interrupt. NewState - ENABLE or DISABLE.
 *
 * @return  none
 */
