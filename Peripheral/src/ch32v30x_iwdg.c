/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32v30x_iwdg.c Author :
 *WCH Version            : V1.0.0 Date               : 2021/06/06 Description :
 *This file provides all the IWDG firmware functions. Copyright (c) 2021 Nanjing
 ...
 *
 * @brief   Enables or disables write access to IWDG_PSCR and IWDG_RLDR
 * registers.
 *
 ...
 * @fn      IWDG_Enable
 *
 * @brief   Enables IWDG (write access to IWDG_PSCR and IWDG_RLDR registers
 * disabled).
 *
 * @return  none
 */
