/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32v30x_rtc.c Author :
 *WCH Version            : V1.0.0 Date               : 2021/06/06 Description :
 *This file provides all the RTC firmware functions. Copyright (c) 2021 Nanjing
 ...
 * disabled. RTC_IT_OW - Overflow interrupt RTC_IT_ALR - Alarm interrupt
 *            RTC_IT_SEC - Second interrupt
 *
 * @return  NewState - new state of the specified RTC interrupts(ENABLE or
 * DISABLE).
 */
