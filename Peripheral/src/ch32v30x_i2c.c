/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32v30x_i2c.c Author :
 *WCH Version            : V1.0.0 Date               : 2021/06/06 Description :
 *This file provides all the I2C firmware functions. Copyright (c) 2021 Nanjing
 ...
 * disabled. I2C_IT_BUF - Buffer interrupt mask. I2C_IT_EVT - Event interrupt
 * mask. I2C_IT_ERR - Error interrupt mask. NewState - ENABLE or DISABLE.
 *
 * @return  none
 */
 ...
 * @return  none
 */
void I2C_SendData(I2C_TypeDef *I2Cx, uint8_t Data) { I2Cx->DATAR = Data; }
 ...
 */
uint8_t I2C_ReceiveData(I2C_TypeDef *I2Cx) { return (uint8_t)I2Cx->DATAR; }
 ...
 */
uint8_t I2C_GetPEC(I2C_TypeDef *I2Cx) { return ((I2Cx->STAR2) >> 8); }
 ...
 *            I2C_IT_ADDR - Address sent flag (Master mode) "ADSL"  Address
 * matched flag (Slave mode)"ENDAD". I2C_IT_SB - Start bit flag (Master mode).
 *
 * @return  none
 */
