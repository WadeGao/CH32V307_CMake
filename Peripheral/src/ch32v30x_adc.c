/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32v30x_adc.c Author :
 *WCH Version            : V1.0.0 Date               : 2021/06/06 Description :
 *This file provides all the ADC firmware functions. Copyright (c) 2021 Nanjing
 ...
 *
 * @param   ADCx - where x can be 1 or 2 to select the ADC peripheral.
 *          ADC_IT - specifies the ADC interrupt sources to be enabled or
 * disabled. ADC_IT_EOC - End of conversion interrupt mask. ADC_IT_AWD - Analog
 * watchdog interrupt mask. ADC_IT_JEOC - End of injected conversion interrupt
 * mask. NewState - ENABLE or DISABLE.
 *
 * @return  none
 */
 ...
 * @return  None
 */
void ADC_StartCalibration(ADC_TypeDef *ADCx) { ADCx->CTLR2 |= CTLR2_CAL_Set; }
 ...
 * channel. ADC_SampleTime_1Cycles5 - Sample time equal to 1.5 cycles.
 ...
 * selected. ADC_ExternalTrigInjecConv_T2_TRGO - Timer2 TRGO event selected.
 *            ADC_ExternalTrigInjecConv_T2_CC1 - Timer2 capture compare1
 * selected. ADC_ExternalTrigInjecConv_T3_CC4 - Timer3 capture compare4
 * selected. ADC_ExternalTrigInjecConv_T4_TRGO - Timer4 TRGO event selected.
