/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32v30x_exti.c Author :
 *WCH Version            : V1.0.0 Date               : 2021/06/06 Description :
 *This file provides all the EXTI firmware functions. Copyright (c) 2021 Nanjing
 ...
 * @return  none.
 */
void EXTI_GenerateSWInterrupt(uint32_t EXTI_Line) { EXTI->SWIEVR |= EXTI_Line; }
 ...
 * @return  None
 */
void EXTI_ClearFlag(uint32_t EXTI_Line) { EXTI->INTFR = EXTI_Line; }
 ...
 * @return  none
 */
void EXTI_ClearITPendingBit(uint32_t EXTI_Line) { EXTI->INTFR = EXTI_Line; }
