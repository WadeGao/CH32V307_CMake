/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32v30x_gpio.c Author :
 *WCH Version            : V1.0.0 Date               : 2021/06/06 Description :
 *This file provides all the GPIO firmware functions. Copyright (c) 2021 Nanjing
 ...
 *
 * @param   GPIOx - where x can be (A..G) to select the GPIO peripheral.
 *          PortVal - specifies the value to be written to the port output data
 * register.
 *
 * @return  none
 */
 ...
 *            GPIO_PartialRemap_USART3 - USART3 Partial Alternate Function
 * mapping GPIO_FullRemap_USART3 - USART3 Full Alternate Function mapping
 ...
 *            GPIO_Remap_ADC1_ETRGINJ - ADC1 External Trigger Injected
 * Conversion remapping GPIO_Remap_ADC1_ETRGREG - ADC1 External Trigger Regular
 * Conversion remapping GPIO_Remap_ADC2_ETRGINJ - ADC2 External Trigger Injected
 * Conversion remapping GPIO_Remap_ADC2_ETRGREG - ADC2 External Trigger Regular
 * Conversion remapping GPIO_Remap_ETH - Ethernet remapping GPIO_Remap_CAN2 -
 * CAN2 remapping GPIO_Remap_MII_RMII_SEL - MII or RMII selection
 *            GPIO_Remap_SWJ_NoJTRST - Full SWJ Enabled (JTAG-DP + SW-DP) but
 * without JTRST GPIO_Remap_SWJ_JTAGDisable - JTAG-DP Disabled and SW-DP Enabled
 *            GPIO_Remap_SWJ_Disable - Full SWJ Disabled (JTAG-DP + SW-DP)
 *            GPIO_Remap_TIM2ITR1_PTP_SOF - Ethernet PTP output or USB OTG SOF
 * (Start of Frame) connected to TIM2 Internal Trigger 1 for calibration
 *            GPIO_Remap_TIM2ITR1_PTP_SOF - Ethernet PTP output or USB OTG SOF
 * (Start of Frame) GPIO_Remap_TIM8 - TIM8 Alternate Function mapping
 ...
 *            GPIO_PartialRemap_USART4 - USART4 Partial Alternate Function
 * mapping GPIO_FullRemap_USART4 - USART4 Full Alternate Function mapping
 *            GPIO_PartialRemap_USART5 - USART5 Partial Alternate Function
 * mapping GPIO_FullRemap_USART5 - USART5 Full Alternate Function mapping
 *            GPIO_PartialRemap_USART6 - USART6 Partial Alternate Function
 * mapping GPIO_FullRemap_USART6 - USART6 Full Alternate Function mapping
 *            GPIO_PartialRemap_USART7 - USART7 Partial Alternate Function
 * mapping GPIO_FullRemap_USART7 - USART7 Full Alternate Function mapping
 *            GPIO_PartialRemap_USART8 - USART8 Partial Alternate Function
 * mapping GPIO_FullRemap_USART8 - USART8 Full Alternate Function mapping
 *            GPIO_Remap_USART1_HighBit - USART1 Alternate Function mapping high
 * bit NewState - ENABLE or DISABLE.
 *
 * @return  none
 */
void GPIO_PinRemapConfig(uint32_t GPIO_Remap, FunctionalState NewState) {
  ...
  if ((GPIO_Remap & 0x80000000) == 0x80000000) { /* PCFR2 */
        ...
        (DBGAFR_LOCATION_MASK | DBGAFR_NUMBITS_MASK)) /* [31:16] 2bit */
    {
      ...
      tmpreg &= ~tmp1;
    } else if ((GPIO_Remap & DBGAFR_NUMBITS_MASK) ==
               DBGAFR_NUMBITS_MASK) /* [15:0] 2bit */
    {
    ...
    if ((GPIO_Remap & (DBGAFR_LOCATION_MASK | DBGAFR_NUMBITS_MASK)) ==
        (DBGAFR_LOCATION_MASK |
         DBGAFR_NUMBITS_MASK)) /* [26:24] 3bit SWD_JTAG */
    {
 ...
 * EXTI lines. This parameter can be GPIO_PortSourceGPIOx where x can be (A..G).
