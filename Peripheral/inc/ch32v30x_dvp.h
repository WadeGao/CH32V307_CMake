/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32v30x_dvp.h Author :
 *WCH Version            : V1.0.0 Date               : 2021/06/06 Description :
 *This file contains all the functions prototypes for the DVP firmware library.
...
void DVP_Cfg(DVP_DMATypeDef s, DVP_FLAG_FIFO_RESETTypeDef i,
             DVP_RX_RESETTypeDef j);
