/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32v30x_misc.h Author :
 *WCH Version            : V1.0.0 Date               : 2021/06/06 Description :
 *This file contains all the functions prototypes for the miscellaneous firmware
 *library functions. Copyright (c) 2021 Nanjing Qinheng Microelectronics Co.,
 *Ltd. SPDX-License-Identifier: Apache-2.0
 *******************************************************************************/
