/********************************** (C) COPYRIGHT
 ******************************** File Name          : ch32v30x_eth.h Author :
 *WCH Version            : V1.0.0 Date               : 2021/06/06 Description :
 *This file contains all the functions prototypes for the ETH firmware library.
...
typedef struct {
  uint32_t
      ETH_AutoNegotiation; /* Selects or not the AutoNegotiation mode for the
                              external PHY The AutoNegotiation allows an
                              automatic setting of the Speed (10/100Mbps) and
                              the mode (half/full-duplex). This parameter can be
                              a value of @ref ETH_AutoNegotiation */

  uint32_t ETH_Watchdog; /* Selects or not the Watchdog timer
                            When enabled, the MAC allows no more then 2048 bytes
                            to be received. When disabled, the MAC can receive
                            up to 16384 bytes. This parameter can be a value of
                            @ref ETH_watchdog */

  uint32_t
      ETH_Jabber; /* Selects or not Jabber timer
                     When enabled, the MAC allows no more then 2048 bytes to be
                     sent. When disabled, the MAC can send up to 16384 bytes.
                     This parameter can be a value of @ref ETH_Jabber */

  uint32_t ETH_InterFrameGap; /* Selects the minimum IFG between frames during
                                 transmission This parameter can be a value of
                                 @ref ETH_Inter_Frame_Gap */
  ...
  uint32_t
      ETH_ReceiveOwn; /* Selects or not the ReceiveOwn
                         ReceiveOwn allows the reception of frames when the
                         TX_EN signal is asserted in Half-Duplex mode This
                         parameter can be a value of @ref ETH_Receive_Own */

  uint32_t ETH_LoopbackMode; /* Selects or not the internal MAC MII Loopback
                                mode This parameter can be a value of @ref
                                ETH_Loop_Back_Mode */

  uint32_t
      ETH_Mode; /* Selects the MAC duplex mode: Half-Duplex or Full-Duplex mode
                   This parameter can be a value of @ref ETH_Duplex_Mode */

  uint32_t ETH_ChecksumOffload; /* Selects or not the IPv4 checksum checking for
                                   received frame payloads' TCP/UDP/ICMP
                                   headers. This parameter can be a value of
                                   @ref ETH_Checksum_Offload */

  uint32_t ETH_RetryTransmission; /* Selects or not the MAC attempt retries
                                     transmission, based on the settings of BL,
                                     when a colision occurs (Half-Duplex mode)
                                     This parameter can be a value of @ref
                                     ETH_Retry_Transmission */

  uint32_t ETH_AutomaticPadCRCStrip; /* Selects or not the Automatic MAC Pad/CRC
                                        Stripping This parameter can be a value
                                        of @ref ETH_Automatic_Pad_CRC_Strip */

  uint32_t ETH_BackOffLimit; /* Selects the BackOff limit value
                                This parameter can be a value of @ref
                                ETH_Back_Off_Limit */

  uint32_t ETH_DeferralCheck; /* Selects or not the deferral check function
                                 (Half-Duplex mode) This parameter can be a
                                 value of @ref ETH_Deferral_Check */

  uint32_t ETH_ReceiveAll; /* Selects or not all frames reception by the MAC (No
                              fitering) This parameter can be a value of @ref
                              ETH_Receive_All */
  ...
  uint32_t ETH_PassControlFrames; /* Sets the forwarding mode of the control
                                     frames (including unicast and multicast
                                     PAUSE frames) This parameter can be a value
                                     of @ref ETH_Pass_Control_Frames */

  uint32_t
      ETH_BroadcastFramesReception; /* Selects or not the reception of Broadcast
                                       Frames This parameter can be a value of
                                       @ref ETH_Broadcast_Frames_Reception */

  uint32_t ETH_DestinationAddrFilter; /* Sets the destination filter mode for
                                         both unicast and multicast frames This
  ...
  uint32_t
      ETH_MulticastFramesFilter; /* Selects the Multicast Frames filter mode:
  ...
  uint32_t ETH_HashTableHigh; /* This field holds the higher 32 bits of Hash
                                 table.  */

  uint32_t
      ETH_HashTableLow; /* This field holds the lower 32 bits of Hash table.  */

  uint32_t ETH_PauseTime; /* This field holds the value to be used in the Pause
                             Time field in the transmit control frame */

  uint32_t
      ETH_ZeroQuantaPause; /* Selects or not the automatic generation of
                              Zero-Quanta Pause Control frames This parameter
                              can be a value of @ref ETH_Zero_Quanta_Pause */

  uint32_t
      ETH_PauseLowThreshold; /* This field configures the threshold of the PAUSE
                                to be checked for automatic retransmission of
                                PAUSE Frame This parameter can be a value of
                                @ref ETH_Pause_Low_Threshold */

  uint32_t
      ETH_UnicastPauseFrameDetect; /* Selects or not the MAC detection of the
                                      Pause frames (with MAC Address0 unicast
                                      address and unique multicast address) This
                                      parameter can be a value of @ref
                                      ETH_Unicast_Pause_Frame_Detect */

  uint32_t ETH_ReceiveFlowControl; /* Enables or disables the MAC to decode the
                                      received Pause frame and disable its
                                      transmitter for a specified time (Pause
                                      Time) This parameter can be a value of
                                      @ref ETH_Receive_Flow_Control */

  uint32_t ETH_TransmitFlowControl; /* Enables or disables the MAC to transmit
                                       Pause frames (Full-Duplex mode) or the
                                       MAC back-pressure operation (Half-Duplex
                                       mode) This parameter can be a value of
                                       @ref ETH_Transmit_Flow_Control */

  uint32_t ETH_VLANTagComparison; /* Selects the 12-bit VLAN identifier or the
                                     complete 16-bit VLAN tag for comparison and
                                     filtering This parameter can be a value of
                                     @ref ETH_VLAN_Tag_Comparison */

  uint32_t ETH_VLANTagIdentifier; /* Holds the VLAN tag identifier for receive
                                     frames */

  uint32_t ETH_DropTCPIPChecksumErrorFrame; /* Selects or not the Dropping of
                                               TCP/IP Checksum Error Frames This
                                               parameter can be a value of @ref
                                               ETH_Drop_TCP_IP_Checksum_Error_Frame
                                             */

  uint32_t
      ETH_ReceiveStoreForward; /* Enables or disables the Receive store and
                                  forward mode This parameter can be a value of
                                  @ref ETH_Receive_Store_Forward */

  uint32_t ETH_FlushReceivedFrame; /* Enables or disables the flushing of
                                      received frames This parameter can be a
                                      value of @ref ETH_Flush_Received_Frame */

  uint32_t
      ETH_TransmitStoreForward; /* Enables or disables Transmit store and
                                   forward mode This parameter can be a value of
                                   @ref ETH_Transmit_Store_Forward */

  uint32_t
      ETH_TransmitThresholdControl; /* Selects or not the Transmit Threshold
                                       Control This parameter can be a value of
                                       @ref ETH_Transmit_Threshold_Control */

  uint32_t ETH_ForwardErrorFrames; /* Selects or not the forward to the DMA of
                                      erroneous frames This parameter can be a
                                      value of @ref ETH_Forward_Error_Frames */

  uint32_t
      ETH_ForwardUndersizedGoodFrames; /* Enables or disables the Rx FIFO to
                                          forward Undersized frames (frames with
                                          no Error and length less than 64
                                          bytes) including pad-bytes and CRC)
                                          This parameter can be a value of @ref
                                          ETH_Forward_Undersized_Good_Frames */

  uint32_t
      ETH_ReceiveThresholdControl; /* Selects the threshold level of the Receive
                                      FIFO This parameter can be a value of @ref
                                      ETH_Receive_Threshold_Control */

  uint32_t ETH_SecondFrameOperate; /* Selects or not the Operate on second frame
                                      mode, which allows the DMA to process a
                                      second frame of Transmit data even before
                                      obtaining the status for the first frame.
                                      This parameter can be a value of @ref
                                      ETH_Second_Frame_Operate */

  uint32_t ETH_AddressAlignedBeats; /* Enables or disables the Address Aligned
                                       Beats This parameter can be a value of
                                       @ref ETH_Address_Aligned_Beats */

  uint32_t ETH_FixedBurst; /* Enables or disables the AHB Master interface fixed
                              burst transfers This parameter can be a value of
                              @ref ETH_Fixed_Burst */

  uint32_t ETH_RxDMABurstLength; /* Indicates the maximum number of beats to be
                                    transferred in one Rx DMA transaction This
                                    parameter can be a value of @ref
                                    ETH_Rx_DMA_Burst_Length */

  uint32_t ETH_TxDMABurstLength; /* Indicates sthe maximum number of beats to be
                                    transferred in one Tx DMA transaction This
                                    parameter can be a value of @ref
                                    ETH_Tx_DMA_Burst_Length */

  uint32_t
      ETH_DescriptorSkipLength; /* Specifies the number of word to skip between
...
#define _eth_delay_ \
  ETH_Delay /* Default _eth_delay_ function with less precise timing */

/* definition for Ethernet frame */
#define ETH_MAX_PACKET_SIZE \
  1520 /* ETH_HEADER + ETH_EXTRA + MAX_ETH_PAYLOAD + ETH_CRC */
#define ETH_HEADER \
...
#define PHY_AutoNego_Complete \
  ((uint16_t)0x0020) /* Auto-Negotioation process completed */
...
#define ETH_MAC_FLAG_TST \
  ((uint32_t)0x00000200) /* Time stamp trigger flag (on MAC) */
...
#define ETH_MAC_IT_TST \
  ((uint32_t)0x00000200) /* Time stamp trigger interrupt (on MAC) */
...
#define ETH_DMATxDesc_ChecksumByPass \
  ((uint32_t)0x00000000) /* Checksum engine bypass */
#define ETH_DMATxDesc_ChecksumIPV4Header \
  ((uint32_t)0x00400000) /* IPv4 header checksum insertion  */
#define ETH_DMATxDesc_ChecksumTCPUDPICMPSegment                            \
  ((uint32_t)0x00800000) /* TCP/UDP/ICMP checksum insertion. Pseudo header \
                            checksum is assumed to be present */
#define ETH_DMATxDesc_ChecksumTCPUDPICMPFull                                  \
  ((uint32_t)0x00C00000) /* TCP/UDP/ICMP checksum fully in hardware including \
                            pseudo header */
...
#define ETH_DMA_FLAG_TST \
  ((uint32_t)0x20000000) /* Time-stamp trigger interrupt (on DMA) */
...
#define ETH_DMA_FLAG_NIS \
  ((uint32_t)0x00010000) /* Normal interrupt summary flag */
#define ETH_DMA_FLAG_AIS \
  ((uint32_t)0x00008000) /* Abnormal interrupt summary flag */
#define ETH_DMA_FLAG_ER ((uint32_t)0x00004000)  /* Early receive flag */
#define ETH_DMA_FLAG_FBE ((uint32_t)0x00002000) /* Fatal bus error flag */
#define ETH_DMA_FLAG_ET ((uint32_t)0x00000400)  /* Early transmit flag */
#define ETH_DMA_FLAG_RWT \
  ((uint32_t)0x00000200) /* Receive watchdog timeout flag */
#define ETH_DMA_FLAG_RPS \
  ((uint32_t)0x00000100) /* Receive process stopped flag */
#define ETH_DMA_FLAG_RBU \
  ((uint32_t)0x00000080) /* Receive buffer unavailable flag */
...
#define ETH_DMA_FLAG_TJT \
  ((uint32_t)0x00000008) /* Transmit jabber timeout flag */
#define ETH_DMA_FLAG_TBU \
  ((uint32_t)0x00000004) /* Transmit buffer unavailable flag */
#define ETH_DMA_FLAG_TPS \
  ((uint32_t)0x00000002) /* Transmit process stopped flag */
#define ETH_DMA_FLAG_T ((uint32_t)0x00000001) /* Transmit flag */

/* DMA interrupt */
#define ETH_DMA_IT_PHYLINK \
  ((uint32_t)0x80000000) /* Internal PHY link status change interrupt */
...
#define ETH_DMA_IT_RWT \
  ((uint32_t)0x00000200) /* Receive watchdog timeout interrupt */
#define ETH_DMA_IT_RPS \
  ((uint32_t)0x00000100) /* Receive process stopped interrupt */
#define ETH_DMA_IT_RBU \
  ((uint32_t)0x00000080) /* Receive buffer unavailable interrupt */
...
#define ETH_DMA_IT_TJT \
  ((uint32_t)0x00000008) /* Transmit jabber timeout interrupt */
#define ETH_DMA_IT_TBU \
  ((uint32_t)0x00000004) /* Transmit buffer unavailable interrupt */
#define ETH_DMA_IT_TPS \
  ((uint32_t)0x00000002) /* Transmit process stopped interrupt */
...
#define ETH_DMA_TransmitProcess_Suspended \
  ((uint32_t)0x00600000) /* Suspended - Tx Desciptor unavailabe */
...
#define ETH_DMA_ReceiveProcess_Suspended \
  ((uint32_t)0x00080000) /* Suspended - Rx Desciptor unavailable */
...
#define ETH_PMT_FLAG_WUFFRPR \
  ((uint32_t)0x80000000) /* Wake-Up Frame Filter Register Poniter Reset */
...
#define ETH_MMC_IT_TGF                                                  \
  ((uint32_t)0x00200000) /* When Tx good frame counter reaches half the \
                            maximum value */
#define ETH_MMC_IT_TGFMSC                                                   \
  ((uint32_t)0x00008000) /* When Tx good multi col counter reaches half the \
                            maximum value */
#define ETH_MMC_IT_TGFSC                                                     \
  ((uint32_t)0x00004000) /* When Tx good single col counter reaches half the \
                            maximum value */

/* MMC RX interrupt flag */
#define ETH_MMC_IT_RGUF                                                      \
  ((uint32_t)0x10020000) /* When Rx good unicast frames counter reaches half \
                            the maximum value */
#define ETH_MMC_IT_RFAE                                                      \
  ((uint32_t)0x10000040) /* When Rx alignment error counter reaches half the \
                            maximum value */
#define ETH_MMC_IT_RFCE                                                        \
  ((uint32_t)0x10000020) /* When Rx crc error counter reaches half the maximum \
                            value */
...
#define ETH_PTP_FLAG_TSITE \
  ((uint32_t)0x00000010) /* Time Stamp Interrupt Trigger */
...
#define ETH_DMASR_TSTS \
  ((unsigned int)0x20000000) /* Time-stamp trigger status */
...
#define ETH_DMASR_EBS_DescAccess \
  ((unsigned int)0x02000000) /* Error bits 0-data buffer, 1-desc. access */
#define ETH_DMASR_EBS_ReadTransf \
  ((unsigned int)0x01000000) /* Error bits 0-write trnsf, 1-read transfr */
#define ETH_DMASR_EBS_DataTransfTx \
  ((unsigned int)0x00800000) /* Error bits 0-Rx DMA, 1-Tx DMA */
#define ETH_DMASR_TPS ((unsigned int)0x00700000) /* Transmit process state */
#define ETH_DMASR_TPS_Stopped \
  ((unsigned int)0x00000000) /* Stopped - Reset or Stop Tx Command issued  */
#define ETH_DMASR_TPS_Fetching \
  ((unsigned int)0x00100000) /* Running - fetching the Tx descriptor */
#define ETH_DMASR_TPS_Waiting \
  ((unsigned int)0x00200000) /* Running - waiting for status */
#define ETH_DMASR_TPS_Reading \
  ((unsigned int)0x00300000) /* Running - reading the data from host memory */
#define ETH_DMASR_TPS_Suspended \
  ((unsigned int)0x00600000) /* Suspended - Tx Descriptor unavailabe */
#define ETH_DMASR_TPS_Closing \
  ((unsigned int)0x00700000) /* Running - closing Rx descriptor */
#define ETH_DMASR_RPS ((unsigned int)0x000E0000) /* Receive process state */
#define ETH_DMASR_RPS_Stopped \
  ((unsigned int)0x00000000) /* Stopped - Reset or Stop Rx Command issued */
#define ETH_DMASR_RPS_Fetching \
  ((unsigned int)0x00020000) /* Running - fetching the Rx descriptor */
#define ETH_DMASR_RPS_Waiting \
  ((unsigned int)0x00060000) /* Running - waiting for packet */
#define ETH_DMASR_RPS_Suspended \
  ((unsigned int)0x00080000) /* Suspended - Rx Descriptor unavailable */
#define ETH_DMASR_RPS_Closing \
  ((unsigned int)0x000A0000) /* Running - closing descriptor */
#define ETH_DMASR_RPS_Queuing                                                 \
  ((unsigned int)0x000E0000) /* Running - queuing the recieve frame into host \
                                memory */
#define ETH_DMASR_NIS ((unsigned int)0x00010000) /* Normal interrupt summary \
                                                  */
#define ETH_DMASR_AIS \
  ((unsigned int)0x00008000) /* Abnormal interrupt summary */
...
#define ETH_DMASR_RWTS \
  ((unsigned int)0x00000200) /* Receive watchdog timeout status */
#define ETH_DMASR_RPSS \
  ((unsigned int)0x00000100) /* Receive process stopped status */
#define ETH_DMASR_RBUS \
  ((unsigned int)0x00000080) /* Receive buffer unavailable status */
...
#define ETH_DMASR_TJTS \
  ((unsigned int)0x00000008) /* Transmit jabber timeout status */
#define ETH_DMASR_TBUS \
  ((unsigned int)0x00000004) /* Transmit buffer unavailable status */
#define ETH_DMASR_TPSS \
  ((unsigned int)0x00000002) /* Transmit process stopped status */
...
#define ETH_MACCR_IFG_96Bit                                                    \
  ((unsigned int)0x00000000) /* Minimum IFG between frames during transmission \
                                is 96Bit */
#define ETH_MACCR_IFG_88Bit                                                    \
  ((unsigned int)0x00020000) /* Minimum IFG between frames during transmission \
                                is 88Bit */
#define ETH_MACCR_IFG_80Bit                                                    \
  ((unsigned int)0x00040000) /* Minimum IFG between frames during transmission \
                                is 80Bit */
#define ETH_MACCR_IFG_72Bit                                                    \
  ((unsigned int)0x00060000) /* Minimum IFG between frames during transmission \
                                is 72Bit */
#define ETH_MACCR_IFG_64Bit                                                    \
  ((unsigned int)0x00080000) /* Minimum IFG between frames during transmission \
                                is 64Bit */
#define ETH_MACCR_IFG_56Bit                                                    \
  ((unsigned int)0x000A0000) /* Minimum IFG between frames during transmission \
                                is 56Bit */
#define ETH_MACCR_IFG_48Bit                                                    \
  ((unsigned int)0x000C0000) /* Minimum IFG between frames during transmission \
                                is 48Bit */
#define ETH_MACCR_IFG_40Bit                                                    \
  ((unsigned int)0x000E0000) /* Minimum IFG between frames during transmission \
                                is 40Bit */
#define ETH_MACCR_CSD \
  ((unsigned int)0x00010000) /* Carrier sense disable (during transmission) */
...
#define ETH_MACCR_APCS \
  ((unsigned int)0x00000080) /* Automatic Pad/CRC stripping */
#define ETH_MACCR_BL                                                         \
  ((unsigned int)0x00000060) /* Back-off limit: random integer number (r) of \
                                slot time delays before reschedulinga        \
                                transmission attempt during retries after a  \
                                collision: 0 =< r <2^k */
...
#define ETH_MACFFR_SAF \
  ((unsigned int)0x00000200) /* Source address filter enable */
#define ETH_MACFFR_SAIF ((unsigned int)0x00000100) /* SA inverse filtering */
#define ETH_MACFFR_PCF \
  ((unsigned int)0x000000C0) /* Pass control frames: 3 cases */
#define ETH_MACFFR_PCF_BlockAll                                              \
  ((unsigned int)0x00000040) /* MAC filters all control frames from reaching \
                                the application */
#define ETH_MACFFR_PCF_ForwardAll                                              \
  ((unsigned int)0x00000080) /* MAC forwards all control frames to application \
                                even if they fail the Address Filter */
#define ETH_MACFFR_PCF_ForwardPassedAddrFilter                            \
  ((unsigned int)0x000000C0) /* MAC forwards control frames that pass the \
                                Address Filter. */
...
#define ETH_MACMIIAR_MR \
  ((unsigned int)0x000007C0) /* MII register in the selected PHY */
#define ETH_MACMIIAR_CR ((unsigned int)0x0000001C) /* CR clock range: 6 cases \
                                                    */
#define ETH_MACMIIAR_CR_Div42 \
  ((unsigned int)0x00000000) /* HCLK:60-100 MHz; MDC clock= HCLK/42 */
#define ETH_MACMIIAR_CR_Div16 \
  ((unsigned int)0x00000008) /* HCLK:20-35 MHz; MDC clock= HCLK/16 */
#define ETH_MACMIIAR_CR_Div26 \
  ((unsigned int)0x0000000C) /* HCLK:35-60 MHz; MDC clock= HCLK/26 */
...
#define ETH_MACMIIDR_MD \
  ((unsigned int)0x0000FFFF) /* MII data: read/write data from/to PHY */
#define ETH_MACFCR_PT ((unsigned int)0xFFFF0000) /* Pause time */
#define ETH_MACFCR_ZQPD \
  ((unsigned int)0x00000080) /* Zero-quanta pause disable */
#define ETH_MACFCR_PLT \
  ((unsigned int)0x00000030) /* Pause low threshold: 4 cases */
#define ETH_MACFCR_PLT_Minus4 \
  ((unsigned int)0x00000000) /* Pause time minus 4 slot times */
#define ETH_MACFCR_PLT_Minus28 \
  ((unsigned int)0x00000010) /* Pause time minus 28 slot times */
#define ETH_MACFCR_PLT_Minus144 \
  ((unsigned int)0x00000020) /* Pause time minus 144 slot times */
#define ETH_MACFCR_PLT_Minus256 \
  ((unsigned int)0x00000030) /* Pause time minus 256 slot times */
#define ETH_MACFCR_UPFD \
  ((unsigned int)0x00000008) /* Unicast pause frame detect */
#define ETH_MACFCR_RFCE \
  ((unsigned int)0x00000004) /* Receive flow control enable */
#define ETH_MACFCR_TFCE \
  ((unsigned int)0x00000002) /* Transmit flow control enable */
#define ETH_MACFCR_FCBBPA \
  ((unsigned int)0x00000001) /* Flow control busy/backpressure activate */

#define ETH_MACVLANTR_VLANTC \
  ((unsigned int)0x00010000) /* 12-bit VLAN tag comparison */
#define ETH_MACVLANTR_VLANTI \
  ((unsigned int)0x0000FFFF) /* VLAN tag identifier (for receive frames) */

#define ETH_MACRWUFFR_D \
  ((unsigned int)0xFFFFFFFF) /* Wake-up frame filter register data */
/* Eight sequential Writes to this address (offset 0x28) will write all
Wake-UpFrame Filter Registers. Eight sequential Reads from this address (offset
0x28) will read all Wake-UpFrame Filter Registers. */
...
#define ETH_MACPMTCSR_WFFRPR \
  ((unsigned int)0x80000000) /* Wake-Up Frame Filter Register Pointer Reset */
#define ETH_MACPMTCSR_GU ((unsigned int)0x00000200) /* Global Unicast */
#define ETH_MACPMTCSR_WFR \
  ((unsigned int)0x00000040) /* Wake-Up Frame Received */
...
#define ETH_MACSR_TSTS \
  ((unsigned int)0x00000200) /* Time stamp trigger status */
...
#define ETH_MACIMR_TSTIM \
  ((unsigned int)0x00000200) /* Time stamp trigger interrupt mask */
...
#define ETH_MACA1HR_MBC                                                        \
  ((unsigned int)0x3F000000) /* Mask byte control: bits to mask for comparison \
                                of the MAC Address bytes */
#define ETH_MACA1HR_MBC_HBits15_8 \
  ((unsigned int)0x20000000) /* Mask MAC Address high reg bits [15:8] */
#define ETH_MACA1HR_MBC_HBits7_0 \
  ((unsigned int)0x10000000) /* Mask MAC Address high reg bits [7:0] */
#define ETH_MACA1HR_MBC_LBits31_24 \
  ((unsigned int)0x08000000) /* Mask MAC Address low reg bits [31:24] */
#define ETH_MACA1HR_MBC_LBits23_16 \
  ((unsigned int)0x04000000) /* Mask MAC Address low reg bits [23:16] */
#define ETH_MACA1HR_MBC_LBits15_8 \
  ((unsigned int)0x02000000) /* Mask MAC Address low reg bits [15:8] */
#define ETH_MACA1HR_MBC_LBits7_0 \
  ((unsigned int)0x01000000) /* Mask MAC Address low reg bits [7:0] */
...
#define ETH_MACA2HR_MBC_LBits7_0 \
  ((unsigned int)0x01000000) /* Mask MAC Address low reg bits [70] */
...
#define ETH_MMCCR_MCFHP \
  ((unsigned int)0x00000020) /* MMC counter Full-Half preset */
...
#define ETH_MMCRIR_RGUFS                                                \
  ((unsigned int)0x00020000) /* Set when Rx good unicast frames counter \
                                reaches half the maximum value */
#define ETH_MMCRIR_RFAES                                                    \
  ((unsigned int)0x00000040) /* Set when Rx alignment error counter reaches \
                                half the maximum value */
#define ETH_MMCRIR_RFCES                                                       \
  ((unsigned int)0x00000020) /* Set when Rx crc error counter reaches half the \
                                maximum value */

#define ETH_MMCTIR_TGFS                                                      \
  ((unsigned int)0x00200000) /* Set when Tx good frame count counter reaches \
                                half the maximum value */
#define ETH_MMCTIR_TGFMSCS                                                 \
  ((unsigned int)0x00008000) /* Set when Tx good multi col counter reaches \
                                half the maximum value */
#define ETH_MMCTIR_TGFSCS                                                   \
  ((unsigned int)0x00004000) /* Set when Tx good single col counter reaches \
                                half the maximum value */

#define ETH_MMCRIMR_RGUFM                                                      \
  ((unsigned int)0x00020000) /* Mask the interrupt when Rx good unicast frames \
                                counter reaches half the maximum value */
#define ETH_MMCRIMR_RFAEM                                                    \
  ((unsigned int)0x00000040) /* Mask the interrupt when when Rx alignment    \
                                error counter reaches half the maximum value \
                              */
#define ETH_MMCRIMR_RFCEM                                                    \
  ((unsigned int)0x00000020) /* Mask the interrupt when Rx crc error counter \
                                reaches half the maximum value */

#define ETH_MMCTIMR_TGFM                                                    \
  ((unsigned int)0x00200000) /* Mask the interrupt when Tx good frame count \
                                counter reaches half the maximum value */
#define ETH_MMCTIMR_TGFMSCM                                               \
  ((unsigned int)0x00008000) /* Mask the interrupt when Tx good multi col \
                                counter reaches half the maximum value */
#define ETH_MMCTIMR_TGFSCM                                                 \
  ((unsigned int)0x00004000) /* Mask the interrupt when Tx good single col \
                                counter reaches half the maximum value */

#define ETH_MMCTGFSCCR_TGFSCC                                                 \
  ((unsigned int)0xFFFFFFFF) /* Number of successfully transmitted frames     \
...
#define ETH_MMCTGFCR_TGFC \
  ((unsigned int)0xFFFFFFFF) /* Number of good frames transmitted. */

#define ETH_MMCRFCECR_RFCEC \
  ((unsigned int)0xFFFFFFFF) /* Number of frames received with CRC error. */

#define ETH_MMCRFAECR_RFAEC                                              \
  ((unsigned int)0xFFFFFFFF) /* Number of frames received with alignment \
                                (dribble) error */

#define ETH_MMCRGUFCR_RGUFC \
  ((unsigned int)0xFFFFFFFF) /* Number of good unicast frames received. */
...
#define ETH_PTPTSCR_TSCNT \
  ((unsigned int)0x00030000) /* Time stamp clock node type */
#define ETH_PTPTSSR_TSSMRME                                                 \
  ((unsigned int)0x00008000) /* Time stamp snapshot for message relevant to \
                                master enable */
#define ETH_PTPTSSR_TSSEME                                                   \
  ((unsigned int)0x00004000) /* Time stamp snapshot for event message enable \
                              */
#define ETH_PTPTSSR_TSSIPV4FE \
  ((unsigned int)0x00002000) /* Time stamp snapshot for IPv4 frames enable */
#define ETH_PTPTSSR_TSSIPV6FE \
  ((unsigned int)0x00001000) /* Time stamp snapshot for IPv6 frames enable */
#define ETH_PTPTSSR_TSSPTPOEFE                                            \
  ((unsigned int)0x00000800) /* Time stamp snapshot for PTP over ethernet \
                                frames enable */
#define ETH_PTPTSSR_TSPTPPSV2E                                              \
  ((unsigned int)0x00000400) /* Time stamp PTP packet snooping for version2 \
                                format enable */
#define ETH_PTPTSSR_TSSSR \
  ((unsigned int)0x00000200) /* Time stamp Sub-seconds rollover */
#define ETH_PTPTSSR_TSSARFE                                                 \
  ((unsigned int)0x00000100) /* Time stamp snapshot for all received frames \
                                enable */

#define ETH_PTPTSCR_TSARU \
  ((unsigned int)0x00000020) /* Addend register update */
#define ETH_PTPTSCR_TSITE \
  ((unsigned int)0x00000010) /* Time stamp interrupt trigger enable */
...
#define ETH_PTPTSCR_TSFCU \
  ((unsigned int)0x00000002) /* Time stamp fine or coarse update */
#define ETH_PTPTSCR_TSE ((unsigned int)0x00000001) /* Time stamp enable */

#define ETH_PTPSSIR_STSSI \
  ((unsigned int)0x000000FF) /* System time Sub-second increment value */

#define ETH_PTPTSHR_STS ((unsigned int)0xFFFFFFFF) /* System Time second */

#define ETH_PTPTSLR_STPNS \
  ((unsigned int)0x80000000) /* System Time Positive or negative time */
#define ETH_PTPTSLR_STSS \
  ((unsigned int)0x7FFFFFFF) /* System Time sub-seconds */

#define ETH_PTPTSHUR_TSUS \
  ((unsigned int)0xFFFFFFFF) /* Time stamp update seconds */

#define ETH_PTPTSLUR_TSUPNS \
  ((unsigned int)0x80000000) /* Time stamp update Positive or negative time */
#define ETH_PTPTSLUR_TSUSS \
  ((unsigned int)0x7FFFFFFF) /* Time stamp update sub-seconds */
...
#define ETH_PTPTSSR_TSTTR \
  ((unsigned int)0x00000020) /* Time stamp target time reached */
#define ETH_PTPTSSR_TSSO \
  ((unsigned int)0x00000010) /* Time stamp seconds overflow */
...
#define ETH_DMABMR_RDP_1Beat                                                 \
  ((unsigned int)0x00020000) /* maximum number of beats to be transferred in \
                                one RxDMA transaction is 1 */
#define ETH_DMABMR_RDP_2Beat                                                 \
  ((unsigned int)0x00040000) /* maximum number of beats to be transferred in \
                                one RxDMA transaction is 2 */
#define ETH_DMABMR_RDP_4Beat                                                 \
  ((unsigned int)0x00080000) /* maximum number of beats to be transferred in \
                                one RxDMA transaction is 4 */
#define ETH_DMABMR_RDP_8Beat                                                 \
  ((unsigned int)0x00100000) /* maximum number of beats to be transferred in \
                                one RxDMA transaction is 8 */
#define ETH_DMABMR_RDP_16Beat                                                \
  ((unsigned int)0x00200000) /* maximum number of beats to be transferred in \
                                one RxDMA transaction is 16 */
#define ETH_DMABMR_RDP_32Beat                                                \
  ((unsigned int)0x00400000) /* maximum number of beats to be transferred in \
                                one RxDMA transaction is 32 */
#define ETH_DMABMR_RDP_4xPBL_4Beat                                           \
  ((unsigned int)0x01020000) /* maximum number of beats to be transferred in \
                                one RxDMA transaction is 4 */
#define ETH_DMABMR_RDP_4xPBL_8Beat                                           \
  ((unsigned int)0x01040000) /* maximum number of beats to be transferred in \
                                one RxDMA transaction is 8 */
#define ETH_DMABMR_RDP_4xPBL_16Beat                                          \
  ((unsigned int)0x01080000) /* maximum number of beats to be transferred in \
                                one RxDMA transaction is 16 */
#define ETH_DMABMR_RDP_4xPBL_32Beat                                          \
  ((unsigned int)0x01100000) /* maximum number of beats to be transferred in \
                                one RxDMA transaction is 32 */
#define ETH_DMABMR_RDP_4xPBL_64Beat                                          \
  ((unsigned int)0x01200000) /* maximum number of beats to be transferred in \
                                one RxDMA transaction is 64 */
#define ETH_DMABMR_RDP_4xPBL_128Beat                                         \
  ((unsigned int)0x01400000) /* maximum number of beats to be transferred in \
                                one RxDMA transaction is 128 */
...
#define ETH_DMABMR_RTPR_1_1 \
  ((unsigned int)0x00000000) /* Rx Tx priority ratio */
#define ETH_DMABMR_RTPR_2_1 \
  ((unsigned int)0x00004000) /* Rx Tx priority ratio */
#define ETH_DMABMR_RTPR_3_1 \
  ((unsigned int)0x00008000) /* Rx Tx priority ratio */
#define ETH_DMABMR_RTPR_4_1 \
  ((unsigned int)0x0000C000) /* Rx Tx priority ratio */
#define ETH_DMABMR_PBL \
  ((unsigned int)0x00003F00) /* Programmable burst length */
#define ETH_DMABMR_PBL_1Beat                                                 \
  ((unsigned int)0x00000100) /* maximum number of beats to be transferred in \
                                one TxDMA (or both) transaction is 1 */
#define ETH_DMABMR_PBL_2Beat                                                 \
  ((unsigned int)0x00000200) /* maximum number of beats to be transferred in \
                                one TxDMA (or both) transaction is 2 */
#define ETH_DMABMR_PBL_4Beat                                                 \
  ((unsigned int)0x00000400) /* maximum number of beats to be transferred in \
                                one TxDMA (or both) transaction is 4 */
#define ETH_DMABMR_PBL_8Beat                                                 \
  ((unsigned int)0x00000800) /* maximum number of beats to be transferred in \
                                one TxDMA (or both) transaction is 8 */
#define ETH_DMABMR_PBL_16Beat                                                \
  ((unsigned int)0x00001000) /* maximum number of beats to be transferred in \
                                one TxDMA (or both) transaction is 16 */
#define ETH_DMABMR_PBL_32Beat                                                \
  ((unsigned int)0x00002000) /* maximum number of beats to be transferred in \
                                one TxDMA (or both) transaction is 32 */
#define ETH_DMABMR_PBL_4xPBL_4Beat                                           \
  ((unsigned int)0x01000100) /* maximum number of beats to be transferred in \
                                one TxDMA (or both) transaction is 4 */
#define ETH_DMABMR_PBL_4xPBL_8Beat                                           \
  ((unsigned int)0x01000200) /* maximum number of beats to be transferred in \
                                one TxDMA (or both) transaction is 8 */
#define ETH_DMABMR_PBL_4xPBL_16Beat                                          \
  ((unsigned int)0x01000400) /* maximum number of beats to be transferred in \
                                one TxDMA (or both) transaction is 16 */
#define ETH_DMABMR_PBL_4xPBL_32Beat                                          \
  ((unsigned int)0x01000800) /* maximum number of beats to be transferred in \
                                one TxDMA (or both) transaction is 32 */
#define ETH_DMABMR_PBL_4xPBL_64Beat                                          \
  ((unsigned int)0x01001000) /* maximum number of beats to be transferred in \
                                one TxDMA (or both) transaction is 64 */
#define ETH_DMABMR_PBL_4xPBL_128Beat                                         \
  ((unsigned int)0x01002000) /* maximum number of beats to be transferred in \
                                one TxDMA (or both) transaction is 128 */
#define ETH_DMABMR_EDE \
  ((unsigned int)0x00000080) /* Enhanced Descriptor Enable */
...
#define ETH_DMAOMR_DTCEFD                                                 \
  ((unsigned int)0x04000000) /* Disable Dropping of TCP/IP checksum error \
                                frames */
#define ETH_DMAOMR_RSF \
  ((unsigned int)0x02000000) /* Receive store and forward */
#define ETH_DMAOMR_DFRF \
  ((unsigned int)0x01000000) /* Disable flushing of received frames */
#define ETH_DMAOMR_TSF \
  ((unsigned int)0x00200000) /* Transmit store and forward */
#define ETH_DMAOMR_FTF ((unsigned int)0x00100000) /* Flush transmit FIFO */
#define ETH_DMAOMR_TTC \
  ((unsigned int)0x0001C000) /* Transmit threshold control */
#define ETH_DMAOMR_TTC_64Bytes                                                 \
  ((unsigned int)0x00000000) /* threshold level of the MTL Transmit FIFO is 64 \
                                Bytes */
#define ETH_DMAOMR_TTC_128Bytes                                             \
  ((unsigned int)0x00004000) /* threshold level of the MTL Transmit FIFO is \
                                128 Bytes */
#define ETH_DMAOMR_TTC_192Bytes                                             \
  ((unsigned int)0x00008000) /* threshold level of the MTL Transmit FIFO is \
                                192 Bytes */
#define ETH_DMAOMR_TTC_256Bytes                                             \
  ((unsigned int)0x0000C000) /* threshold level of the MTL Transmit FIFO is \
                                256 Bytes */
#define ETH_DMAOMR_TTC_40Bytes                                                 \
  ((unsigned int)0x00010000) /* threshold level of the MTL Transmit FIFO is 40 \
                                Bytes */
#define ETH_DMAOMR_TTC_32Bytes                                                 \
  ((unsigned int)0x00014000) /* threshold level of the MTL Transmit FIFO is 32 \
                                Bytes */
#define ETH_DMAOMR_TTC_24Bytes                                                 \
  ((unsigned int)0x00018000) /* threshold level of the MTL Transmit FIFO is 24 \
                                Bytes */
#define ETH_DMAOMR_TTC_16Bytes                                                 \
  ((unsigned int)0x0001C000) /* threshold level of the MTL Transmit FIFO is 16 \
                                Bytes */
#define ETH_DMAOMR_ST \
  ((unsigned int)0x00002000) /* Start/stop transmission command */
#define ETH_DMAOMR_FEF ((unsigned int)0x00000080) /* Forward error frames */
#define ETH_DMAOMR_FUGF \
  ((unsigned int)0x00000040) /* Forward undersized good frames */
#define ETH_DMAOMR_RTC \
  ((unsigned int)0x00000018) /* receive threshold control */
#define ETH_DMAOMR_RTC_64Bytes                                                \
  ((unsigned int)0x00000000) /* threshold level of the MTL Receive FIFO is 64 \
                                Bytes */
#define ETH_DMAOMR_RTC_32Bytes                                                \
  ((unsigned int)0x00000008) /* threshold level of the MTL Receive FIFO is 32 \
                                Bytes */
#define ETH_DMAOMR_RTC_96Bytes                                                \
  ((unsigned int)0x00000010) /* threshold level of the MTL Receive FIFO is 96 \
                                Bytes */
#define ETH_DMAOMR_RTC_128Bytes                                                \
  ((unsigned int)0x00000018) /* threshold level of the MTL Receive FIFO is 128 \
                                Bytes */
...
#define ETH_DMAIER_NISE \
  ((unsigned int)0x00010000) /* Normal interrupt summary enable */
#define ETH_DMAIER_AISE \
  ((unsigned int)0x00008000) /* Abnormal interrupt summary enable */
#define ETH_DMAIER_ERIE \
  ((unsigned int)0x00004000) /* Early receive interrupt enable */
#define ETH_DMAIER_FBEIE \
  ((unsigned int)0x00002000) /* Fatal bus error interrupt enable */
#define ETH_DMAIER_ETIE \
  ((unsigned int)0x00000400) /* Early transmit interrupt enable */
#define ETH_DMAIER_RWTIE \
  ((unsigned int)0x00000200) /* Receive watchdog timeout interrupt enable */
#define ETH_DMAIER_RPSIE \
  ((unsigned int)0x00000100) /* Receive process stopped interrupt enable */
#define ETH_DMAIER_RBUIE \
  ((unsigned int)0x00000080) /* Receive buffer unavailable interrupt enable */
#define ETH_DMAIER_RIE ((unsigned int)0x00000040) /* Receive interrupt enable \
                                                   */
#define ETH_DMAIER_TUIE \
  ((unsigned int)0x00000020) /* Transmit Underflow interrupt enable */
#define ETH_DMAIER_ROIE \
  ((unsigned int)0x00000010) /* Receive Overflow interrupt enable */
#define ETH_DMAIER_TJTIE \
  ((unsigned int)0x00000008) /* Transmit jabber timeout interrupt enable */
#define ETH_DMAIER_TBUIE                                                     \
  ((unsigned int)0x00000004) /* Transmit buffer unavailable interrupt enable \
                              */
#define ETH_DMAIER_TPSIE \
  ((unsigned int)0x00000002) /* Transmit process stopped interrupt enable */
#define ETH_DMAIER_TIE \
  ((unsigned int)0x00000001) /* Transmit interrupt enable */

#define ETH_DMAMFBOCR_OFOC \
  ((unsigned int)0x10000000) /* Overflow bit for FIFO overflow counter */
#define ETH_DMAMFBOCR_MFA \
  ((unsigned int)0x0FFE0000) /* Number of frames missed by the application */
#define ETH_DMAMFBOCR_OMFC \
  ((unsigned int)0x00010000) /* Overflow bit for missed frame counter */
#define ETH_DMAMFBOCR_MFC \
  ((unsigned int)0x0000FFFF) /* Number of frames missed by the controller */

#define ETH_DMACHTDR_HTDAP \
  ((unsigned int)0xFFFFFFFF) /* Host transmit descriptor address pointer */
#define ETH_DMACHRDR_HRDAP \
  ((unsigned int)0xFFFFFFFF) /* Host receive descriptor address pointer */
#define ETH_DMACHTBAR_HTBAP \
  ((unsigned int)0xFFFFFFFF) /* Host transmit buffer address pointer */
#define ETH_DMACHRBAR_HRBAP \
  ((unsigned int)0xFFFFFFFF) /* Host receive buffer address pointer */

#define ETH_MAC_ADDR_HBASE \
  (ETH_MAC_BASE + 0x40) /* ETHERNET MAC address high offset */
#define ETH_MAC_ADDR_LBASE \
  (ETH_MAC_BASE + 0x44) /* ETHERNET MAC address low offset */
...
uint32_t ETH_WritePHYRegister(uint16_t PHYAddress, uint16_t PHYReg,
                              uint16_t PHYValue);
...
void ETH_DMATxDescRingInit(ETH_DMADESCTypeDef *DMATxDescTab, uint8_t *TxBuff1,
                           uint8_t *TxBuff2, uint32_t TxBuffCount);
FlagStatus ETH_GetDMATxDescFlagStatus(ETH_DMADESCTypeDef *DMATxDesc,
                                      uint32_t ETH_DMATxDescFlag);
...
void ETH_DMATxDescFrameSegmentConfig(ETH_DMADESCTypeDef *DMATxDesc,
                                     uint32_t DMATxDesc_FrameSegment);
...
void ETH_DMATxDescBufferSizeConfig(ETH_DMADESCTypeDef *DMATxDesc,
                                   uint32_t BufferSize1, uint32_t BufferSize2);
void ETH_DMARxDescChainInit(ETH_DMADESCTypeDef *DMARxDescTab, uint8_t *RxBuff,
                            uint32_t RxBuffCount);
void ETH_DMARxDescRingInit(ETH_DMADESCTypeDef *DMARxDescTab, uint8_t *RxBuff1,
                           uint8_t *RxBuff2, uint32_t RxBuffCount);
FlagStatus ETH_GetDMARxDescFlagStatus(ETH_DMADESCTypeDef *DMARxDesc,
                                      uint32_t ETH_DMARxDescFlag);
...
void ETH_DMARxDescSecondAddressChainedCmd(ETH_DMADESCTypeDef *DMARxDesc,
                                          FunctionalState NewState);
uint32_t ETH_GetDMARxDescBufferSize(ETH_DMADESCTypeDef *DMARxDesc,
                                    uint32_t DMARxDesc_Buffer);
...
uint32_t ETH_HandlePTPTxPkt(uint8_t *ppkt, uint16_t FrameLength,
                            uint32_t *PTPTxTab);
